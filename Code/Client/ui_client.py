...
"font: 10pt \"Arial\";")
        ...
        self.debug_console = QtWidgets.QLineEdit(client)
        self.debug_console.setGeometry(QtCore.QRect(40, 100, 200, 30))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(9)
        font.setBold(False)
        ...
        self.debug_console.setStyleSheet("font: 10pt \"Arial\";")
        self.debug_console.setAlignment(QtCore.Qt.AlignCenter)
        self.debug_console.setObjectName("debug_console")

        self.Button_Run_Cmd = QtWidgets.QPushButton(client)
        self.Button_Run_Cmd.setGeometry(QtCore.QRect(270, 100, 90, 30))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(9)
        font.setBold(False)
        font.setItalic(False)
        font.setWeight(50)
        self.Button_Run_Cmd.setFont(font)
        self.Button_Run_Cmd.setStyleSheet("font: 10pt \"Arial\";")
        self.Button_Run_Cmd.setObjectName("Button_Run_Cmd")
        ...
        self.Button_StairClimb = QtWidgets.QPushButton(client)
        self.Button_StairClimb.setGeometry(QtCore.QRect(40, 40, 90, 30))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(9)
        font.setBold(False)
        font.setItalic(False)
        font.setWeight(50)
        self.Button_StairClimb.setFont(font)
        self.Button_StairClimb.setStyleSheet("font: 10pt \"Arial\";")
        self.Button_StairClimb.setObjectName("Button_StairClimb")
...
"font: 10pt \"Arial\";")
    ...
    def retranslateUi(self, client):
        ...
        self.debug_console.setText(_translate("client", ""))
        self.Button_Connect.setText(_translate("client", "Connect"))
        self.Button_Run_Cmd.setText(_translate("client", "Run Cmd"))
        ...
        self.Button_StairClimb.setText(_translate("client", "Stair Climb"))
